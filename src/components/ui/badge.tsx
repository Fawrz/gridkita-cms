  ...
  "group/badge inline-flex min-h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-semibold whitespace-nowrap transition-[background-color,border-color,color] focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        ...
        info: "border-info/30 bg-info/12 text-info dark:bg-info/20",
        coral: "border-orange-500/25 bg-orange-500/12 text-orange-700 dark:text-orange-300",
        popular: "border-warning/40 bg-warning text-warning-foreground shadow-sm shadow-warning/20",
